...
export const translations: Translations = {
  fr: {
    ...
    "wizard.step4.title": "Pages supplémentaires",
    "wizard.step4.subtitle": "Ajoutez des pages spécifiques à auditer",
  ...
  en: {
    ...
    "wizard.step4.title": "Additional Pages",
    "wizard.step4.subtitle": "Add specific pages to audit",
