...
const WelcomeEmail: React.FC<WelcomeEmailProps> = ({
  ...
  const content = language === 'fr' ? {
    preview: 'Bienvenue sur AISEO - Votre plateforme GEO',
    title: 'Bienvenue sur AISEO!',
    greeting: `Bonjour ${name},`,
    intro: 'Merci de vous etre inscrit sur AISEO, votre plateforme de GEO (Generative Engine Optimization).',
    ...
    feature3: 'Recevoir des recommandations pour ameliorer votre visibilite IA',
    ctaText: 'Acceder au tableau de bord',
    support: 'Si vous avez des questions, n\'hesitez pas a nous contacter.',
    signature: 'L\'equipe AISEO',
  } : {
    preview: 'Welcome to AISEO - Your GEO Platform',
    title: 'Welcome to AISEO!',
    greeting: `Hello ${name},`,
    intro: 'Thank you for signing up for AISEO, your GEO (Generative Engine Optimization) platform.',
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Heading as="h3" style={sectionTitle}>{content.whatNext}</Heading>
