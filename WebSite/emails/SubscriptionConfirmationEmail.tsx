...
const SubscriptionConfirmationEmail: React.FC<SubscriptionConfirmationEmailProps> = ({
  name,
  tier,
  amount,
  currency,
  ...
  const tierDisplayName = {
    basic: language === 'fr' ? 'Basic (Audit Unique)' : 'Basic (One-Time Audit)',
  ...
  const isOneShot = tier.toLowerCase() === 'basic' || tier.toLowerCase() === 'pro';

  const content = language === 'fr' ? {
    preview: isOneShot
      ? 'Confirmation de votre achat AISEO'
    ...
    support: 'Si vous avez des questions concernant votre abonnement, n\'hesitez pas a nous contacter.',
    signature: 'L\'equipe AISEO',
  } : {
    preview: isOneShot
      ? 'Your AISEO purchase is confirmed'
    ...
    support: 'If you have any questions about your subscription, feel free to reach out.',
    signature: 'The AISEO Team',
  };

  const baseUrl = process.env.NEXTAUTH_URL || 'https://aiseo.com';
        ...
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Section style={detailsBox}>
              <Heading as="h3" style={detailsTitle}>{content.details}</Heading>
