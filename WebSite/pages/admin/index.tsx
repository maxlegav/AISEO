        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <StatCard
              ...
              href="/admin/audits?status=questions_review"
            />
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                {stats.audits.audit_review > 0 && (
                  <Link
                    href="/admin/audits?status=audit_review"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
              <StatusCard label="Pending" value={stats.audits.pending} color="bg-gray-600" />
              <StatusCard label="Generating" value={stats.audits.generating} color="bg-blue-600" />
              <StatusCard label="Questions Review" value={stats.audits.questions_review} color="bg-amber-600" />
              <StatusCard label="Auditing" value={stats.audits.auditing} color="bg-indigo-600" />
              <StatusCard label="Audit Review" value={stats.audits.audit_review} color="bg-yellow-600" />
              <StatusCard label="Completed" value={stats.audits.completed} color="bg-green-600" />
              <StatusCard label="Rejected" value={stats.audits.rejected} color="bg-orange-600" />
              <StatusCard label="Failed" value={stats.audits.failed} color="bg-red-600" />
            </div>
          </div>
        </div>
      ) : (
